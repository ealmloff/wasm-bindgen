...
use wasm_bindgen::convert::{ArgAbi, CallScoped};
...
impl<T: JsGeneric + ArgAbi<CallScoped, Guard = Option<T>> + WasmDescribe> JsStream<T> {
...
impl<T: JsGeneric + ArgAbi<CallScoped, Guard = Option<T>> + WasmDescribe + Unpin> Stream
    for JsStream<T>
{
